        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: GridView.count(crossAxisCount: 3, shrinkWrap: true, physics: const NeverScrollableScrollPhysics(), childAspectRatio: 1.5, mainAxisSpacing: 16, crossAxisSpacing: 16, children: [for (var i = 1; i <= 9; i++) _key(i.toString()), _key("*"), _key("0"), _key("#")]),
            ),
